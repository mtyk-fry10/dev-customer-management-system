...
<div id="page-content">
    <div class="container">
        <div class="row justify-content-left">
            <div class="col-md-12">
                <h4 class="font-weight-light mt-4">新規登録</h4>
                ...
                <div class="container mt-5">
                    ...
                    <form action="" method="post" class="needs-validation" novalidate>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="address" name="address" value="{{ old('address') }}" class="form-control @if($errors->has('address')) is-invalid @endif" id="inputAddress" placeholder="〒100-0013 東京都千代田区霞が関2丁目1-1" required>
